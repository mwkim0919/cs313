	...
	@Override protected void fetch () throws Register.TimingException {
		try {
			...
			case I_RANDL:		
				...
				break;
				// QUESTION 2 I_RMMOVL AND I_MRMOVL's iFn can be either 0 or 4
			case I_RMMOVL:
			case I_MRMOVL:
				switch (f.iFn.getValueProduced()) {
				case 0x0:
				...
				break;
				// QUESTION 3 I_CALL's iFn can be either 0 or 9
			case I_CALL:
				switch (f.iFn.getValueProduced()) {
				case 0x0:
				case 0x9:
	...
	@Override protected void execute () throws Register.TimingException {
		...
		if (E.stat.get()==S_AOK) {
			...
			case A_MODL:
				...
				overflow = aluA == 0;
				break;
			case A_RANDL:		// QUESTION 1
				Random random = new Random();
				e.valE.set (random.nextInt());
				overflow = false;
				break;
			default:
				overflow = false;
