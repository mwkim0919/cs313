...
public class CPU extends AbstractY86CPU.Pipelined {
  ...
  {
    return reg != R_NONE && (E.dstE.get() == reg || /* Change M.dstE to E.dstM */ E.dstM.get() == reg
    						/* Code Added */
  ...
  @Override protected void pipelineHazardControl () throws Register.TimingException {
    ...
    // Data Hazards
    if (isDataHazardOnReg (d.srcA.getValueProduced()) /* Code Added */ || isDataHazardOnReg (d.srcB.getValueProduced())) {
      F.stall  = true;
      D.stall  = true;
      E.bubble = true;
    }
